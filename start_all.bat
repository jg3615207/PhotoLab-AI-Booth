@echo off
title PhotoLab AI Booth - All-In-One (AIO) Launcher v0.43.0
color 0A

echo ===================================================================
echo             🚀 PhotoLab AI Booth - All-In-One (AIO) Launcher v0.43.0
echo ===================================================================
echo.
...
start "PhotoLab Cloudflare Tunnel" cmd /k "title PhotoLab Cloudflare Tunnel && cloudflared tunnel run --url http://127.0.0.1:8765 photolab"
...
echo   💻 Local Host Access   : http://127.0.0.1:8765/
echo   🖨️ Standalone Print App: Running (Tkinter GUI active)
echo.
echo ===================================================================
echo   [1] Open Web Admin in Browser (Cloudflare Tunnel)
echo   [2] Open Kiosk App in Browser (Cloudflare Tunnel)
echo   [3] Open Local Host Access (http://127.0.0.1:8765)
echo   [4] Exit Launcher (Services will remain running)
echo ===================================================================
echo.
...
if "%choice%"=="3" start http://127.0.0.1:8765/ & goto MENU
if "%choice%"=="4" exit
goto MENU
